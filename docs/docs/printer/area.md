...
<p align="center"><a href="https://github.com/gemini/pterm/blob/master/_examples/area/main.go" target="_blank">(Show source of demo)</a></p>
...
|--------|-----------|
|[Update](https://pkg.go.dev/github.com/gemini/pterm#AreaPrinter.Update)|Update overwrites the content of the AreaPrinter.|
|[GetContent](https://pkg.go.dev/github.com/gemini/pterm#AreaPrinter.GetContent)|GetContent returns the current area content.|
|[Clear](https://pkg.go.dev/github.com/gemini/pterm#AreaPrinter.Clear)|Clear function clears the content of the area.|
...
|Option|Type|
|------|----|
|[RemoveWhenDone](https://pkg.go.dev/github.com/gemini/pterm#AreaPrinter.RemoveWhenDone)|bool|
|[Fullscreen](https://pkg.go.dev/github.com/gemini/pterm#AreaPrinter.Fullscreen)|bool|
|[Center](https://pkg.go.dev/github.com/gemini/pterm#AreaPrinter.Center)|bool|
